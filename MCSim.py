...
def initialize_board(num_people=100):
...
def random_walk_step(init_pos, speed=20 ,infected=1):
...
def near_infected(infected,pos,person, social_distance=6, r0=2):
...
def main():
    ...
    while running:
        ...
        pos = random_walk_step(pos,10,infected)
